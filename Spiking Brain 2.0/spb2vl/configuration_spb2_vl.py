...
class SPB2VLVisionConfig(PretrainedConfig):
    """Vision configuration for SPB2VL (same as Qwen3VL Vision)."""
    model_type = "spb2_vl"
...
class SPB2VLTextConfig(PretrainedConfig):
    """Text configuration for SPB2VL (based on SSE-SWA-MoBA)."""
    model_type = "spb2_vl_text"
    base_config_key = "text_config"

    def __init__(
        self,
        # SSE-SWA-MoBA specific parameters
        attn_mode: str = "chunk",
...
class SPB2VLConfig(PretrainedConfig):
    """
    Configuration class for SPB2VL model.
    Combines Qwen3VL vision encoder with SSE-SWA-MoBA text model.
    """
    model_type = "spb2_vl"
    sub_configs = {"vision_config": SPB2VLVisionConfig, "text_config": SPB2VLTextConfig}
